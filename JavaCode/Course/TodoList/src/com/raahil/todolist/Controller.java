...
public class Controller {
    ...
    public void initialize(){
        ...
        deleteMenuItem.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                TodoItem item = TodoData.getInstance().getTodoItems().get((Integer) todoListView.getSelectionModel().getSelectedIndices().get(0));
                deleteItem(item);
            }
        });
        ...
        filteredItems = new Predicate<TodoItem>() {
            @Override
            public boolean test(TodoItem todoItem) {
                if(todoItem.getDeadLine().isAfter(LocalDate.now().minusDays(1))&&todoItem.getDeadLine().isBefore(LocalDate.now().plusDays(6))){
                    return true;
                }else{
                    return false;
                }
    ...
    public void showNewItemDialog(){
        ...
        dialog.setHeaderText("Use this form to create a new todo item.");
    ...
    public void updateCurrent(){
        TodoItem item = TodoData.getInstance().getTodoItems().get((Integer) todoListView.getSelectionModel().getSelectedIndices().get(0));
        item.setDetails(itemDetailsTextArea.getText());
    }
    @FXML
    ...
    public void handleKeyPressed(KeyEvent keyEvent){
        TodoItem selectedItem = TodoData.getInstance().getTodoItems().get((Integer) todoListView.getSelectionModel().getSelectedIndices().get(0));
